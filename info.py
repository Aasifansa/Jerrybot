...
PICS = (environ.get('PICS', 'https://envs.sh/RxQ.jpg')).split() #SAMPLE PIC
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_too_penlink/29') # Tutorial video link for opening shortlink website 
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/movieupdtehub')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Aesthicunivars') #Support group link ( make sure bot is admin )
